...
class FormQuestionEditRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name'         => 'required||min:5|unique:sections,name,'.$this->question->id,
    ...
    public function messages()
    {
        return [
            ...
            'type.required'         =>  'El tipo de preguntaes requerida.',
        ];
    }
}
