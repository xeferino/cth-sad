<!-- Modal -->
<div class="modal hide fade in"  style="z-index: 1400;" data-keyboard="false" data-backdrop="static" id="modal-section-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content modal-content-modal">
			<div class="modal-body">
                <form method="POST" name="form-section-edit" id="form-section-edit" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" aria-label="name" name="name" id="name_sect_poll_e">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" aria-label="description" name="description" id="description_sect_poll_e">
                                    <div class="input-group-append">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group form-floating-label">
                                ...
                                <button type="submit" class="btn btn-sm btn-secondary float-right" id="btn-section-edit">Editar</button>
                            </div>
                        </div>
                    </div>
                </form>
