<!-- Modal -->
<div class="modal hide fade in"  style="z-index: 1400;" data-keyboard="false" data-backdrop="static" id="modal-route-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content modal-content-modal">
			<div class="modal-body">
                <form method="POST" name="form-route-edit" id="form-route-edit" enctype="multipart/form-data">
                    <input type="hidden" name="id_route" id="id_route">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="alert alert-secondary" role="alert">
                                <p class="card-category card-category-title route-title"></p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" aria-label="code_e" name="code_e" id="code_e">
                                    <div class="input-group-append">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group form-floating-label">
                                ...
                                <select class="form-control" style="width:100%" id="canton_id_e" name="canton_id"></select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group form-floating-label">
                                ...
                                <button type="submit" class="btn btn-sm btn-secondary float-right" id="btn-route-edit">Editar</button>
                            </div>
                        </div>
                    </div>
                </form>
