@extends('layouts.app', ['title' => $title ?? 'Tabulaciones por Preguntas'])
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('tabs.pdf.question') }}" name="form-tab" id="form-tab" target="_blank">
                            <div class="row">
...
jQuery(document).ready(function($){
    $('#form-tab').on('submit',function(e) {
        ...
        var url = '{{ url('tabs/pdf') }}/questions?poll='+$('#poll').val()+'&canton='+$('#canton').val();
