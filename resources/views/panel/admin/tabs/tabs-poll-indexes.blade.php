        ...
        @foreach ($cantons as $tab)
            ...
            <table align="center" width="100%" cellpadding="0" cellspacing="0" style="border: none !important;">
                <tr style="text-align: center; border: none !important;">
                    <td colspan="5"><img style="text-align: left; padding-bottom:5px;" src="{{ asset('img/polling.svg') }}" width="5%" alt=""><br><span style="text-align: center; font-size:14px; font-weight:bold;">CÁLCULO DE INDICE DE SATISFACCIÓN AL CLIENTE (TODOS)</span></td>
                </tr>
            </table>
            <br><br>
                        ...
                        <table align="center" width="100%" cellpadding="0" cellspacing="0" style="border: solid #000000 0.5px !important;">
                            ...
                            @if ($section['questions'])
                                ...
                                @foreach ($section['questions'] as $question)
                                    ...
                                    @php  $average += $question['percent']; @endphp
                                    <tr style="text-align: cent; border: solid #000 0.5px !important;">
                                        ...
                                        <td style="border: solid #000 0.5px !important;"  width="15%"><p style="text-align: center; margin-left:10px; font-size:12px; font-weight:bold; font-size:12px;">{{ $question['percent'] }}</p></td>
                                    </tr>
                                    @endif
                                @endforeach
                            @endif
        ...
        @foreach ($cantons as $tab)
            ...
            <table align="center" width="100%" cellpadding="0" cellspacing="0" style="border: solid #000000 0.5px !important;">
                ...
                @foreach ($tab['sections'] as $section)
                        ...
                        @php  $total_average += sprintf('%0.2f', $average/count($section['questions'])); @endphp
    ...
    @if ($tab['sections'])
        ...
        @php $sections [] = $section['id']; @endphp
            ...
            @if ($section['questions'])
                ...
                @php $mayor_o_igual_a_7_q = 0; @endphp
                @php $menor_a_7_q = 0; @endphp
                @php $percent_q = 0; @endphp
                ...
                @foreach ($section['questions'] as $question)
                    @if ($question['type']=="close")
                        @php  $average += $question['percent']; @endphp
                        @php $total_q += $question['total'] @endphp
                        @php $mayor_o_igual_a_7_q += $question['mayor_o_igual_a_7'] @endphp
                        @php $menor_a_7_q += $question['menor_a_7'] @endphp
                        @php $percent_q += $question['percent'] @endphp
                        @php $questions[]= "P".$i++; @endphp
                        @php $questdata[]= $question['percent']; @endphp
                    @endif
                @endforeach
            ...
            <script>
                ...
                if(questions.length=="4"){
                    var color = ['white', 'white', 'orange', 'white'];
                }else if(questions.length=="5"){
                    var color = ['white', 'white', 'white', 'orange', 'white'];
                }else if(questions.length=="6"){
                    var color = ['white', 'white', 'white', 'white', 'orange', 'white'];
                }else if(questions.length=="7"){
                    var color = ['white', 'white', 'white', 'white', 'white', 'orange', 'white'];
                }else if(questions.length=="10"){
                    var color = ['white', 'white', 'white', 'white', 'white', 'white', 'white', 'white', 'orange', 'white'];
                }
        ...
        @endforeach
    @endif
    @php $sections [] = 'ISC Total Provincia';  @endphp
